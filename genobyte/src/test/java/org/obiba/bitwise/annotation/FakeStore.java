...
public class FakeStore {
  ...
  @Stored private String name = null;
  private String snp = null;
  //TODO: gene name in store is gene_wow, dictionary used is "names"
  @Stored(dictionary="names", field="gene_name") private String gene = null;
  //TODO: age dictionary is default Integer dictionary
  @Stored(field="age") private Integer age = null;
  ...
  public String toString() {
    ...
    sb.append("FakeStore{ snp=[").append(snp).append("]")
      .append(" name=[").append(name).append("]")
      .append(" gene=[").append(gene).append("]")
      .append("}");
    return sb.toString();
  }
