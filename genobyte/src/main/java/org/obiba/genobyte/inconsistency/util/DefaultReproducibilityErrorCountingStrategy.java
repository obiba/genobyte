...
public class DefaultReproducibilityErrorCountingStrategy<K, TK> implements ReproducibilityErrorCountingStrategy<K> {
  ...
  public DefaultReproducibilityErrorCountingStrategy(DefaultGenotypingField field, DefaultGenotypingField testField, GenotypingRecordStore<K, ?, TK> store, GenotypingRecordStore<TK, ?, K> transposedStore) {
    store_ = store;
