...
public class BdbContext implements KeyedDaoManagerDestroyListener {
  ...
  static void createInstance(DaoKey key, Properties props) throws DatabaseException {
    ...
    for (Enumeration<?> e = props.propertyNames(); e.hasMoreElements(); ) {
      ...
      if (ConfigurationPropertiesProvider.ROOT_DIR_PROPERTY.equals(propName)) {
    ...
    if (root == null) {
      throw new IllegalStateException(
          "Configuration property [" + ConfigurationPropertiesProvider.ROOT_DIR_PROPERTY + "] is missing.");
    }
