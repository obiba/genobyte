...
public class StoreFromAnnotationTest extends BaseBdbDaoTestCase {
  ...
  public void testInvalidStoreCreation() {
    ...
    createFaultySchema(FakeFaultyStore1.class, "Class [org.obiba.bitwise.annotation.FakeFaultyStore1] can only have one of these attributes: dictionaryClass, dictionaryClassName.");
    
    //When none of dictionaryClassName and dictionaryClassName are defined for a DictionaryDef
    createFaultySchema(FakeFaultyStore2.class, "Class [org.obiba.bitwise.annotation.FakeFaultyStore2] should have at least one of these attributes: dictionaryClass, dictionaryClassName.");

    //When one property has two @Stored annotations
    createFaultySchema(FakeFaultyStore3.class, "Class [org.obiba.bitwise.annotation.FakeFaultyStore3] declares a property [id] that has more than one of these annotations (@Stored or @NotStored).");
    
    //When one property has both @Stored and @NotStored annotations
    createFaultySchema(FakeFaultyStore4.class, "Class [org.obiba.bitwise.annotation.FakeFaultyStore4] declares a property [id] that has more than one of these annotations (@Stored or @NotStored).");
  }
