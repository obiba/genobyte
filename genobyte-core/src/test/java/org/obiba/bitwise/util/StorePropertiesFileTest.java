...
public class StorePropertiesFileTest extends TestCase {
  ...
  private final String propertyFileLocation_
      = "./src/test/java/org/obiba/bitwise/util/defaultPropertyFile/bitwise.properties";
  ...
  public void testPropertiesFile() {
    ...
    DefaultConfigurationPropertiesProvider cpp = (DefaultConfigurationPropertiesProvider) BitwiseStoreUtil.getInstance()
        .getConfigurationPropertiesProvider();
